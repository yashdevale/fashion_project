...
def add_final_training_ops(class_count, final_tensor_name, bottleneck_tensor):
  ...
  with tf.name_scope('cross_entropy'):
    # cross_entropy_mean = tf.nn.sparse_softmax_cross_entropy(
    #     labels=ground_truth_input, logits=logits)

    cross_entropy = tf.nn.softmax_cross_entropy_with_logits(labels=ground_truth_input,logits=logits)
    # cross_entropy = tf.reduce_mean(tf.nn.sparse_softmax_cross_entropy_with_logits(logits=logits,labels=ground_truth_input))
